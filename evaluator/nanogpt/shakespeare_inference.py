...
def inference(
    model_path, prompt, num_tokens=100, temperature=0.8, top_k=40, device="cuda"
):
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Run inference on a trained Shakespeare model"
    )
    ...
    parser.add_argument(
        "--top_k", type=int, default=40, help="Limit sampling to top k tokens"
    )
    parser.add_argument(
        "--device",
        type=str,
